...
class ReportDeliveryNoteController extends Controller
{
    ...
    public function index_accounts_receivable_note($typepersone,$id_client_or_vendor,$date_end = null,$date_frist = null,$typeinvoice = 'todo')
    {        
        ...
        if($userAccess->validate_user_access($this->modulo)){
            ...
            return view('admin.reports.index_accounts_receivable_note',compact('client','typepersone','vendor','date_end','date_frist','typeinvoice','id_client_or_vendor'));
