...
<table style="width: 100%;">
  ...
  @endif
    ...
    <tr>
      <th style="text-align: left; font-weight: normal; width: 79%; border-top-color: rgb(17, 9, 9); border-right-color: white; font-size: small;"> Tasa: {{ number_format(bcdiv($quotation->bcv, '1', 2), 2, ',', '.') }}</th>
